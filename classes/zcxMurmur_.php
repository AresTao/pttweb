...
if(!class_exists('Murmur_User'))
{
    class Murmur_User
    {
        public function __construct($session=0, $userid=0, $mute=false, $deaf=false, $suppress=false, $prioritySpeaker=false, $selfMute=false, $selfDeaf=false, $recording=false, $online=false, $channel=0, $name='', $onlinesecs=0, $bytespersec=0, $version=0, $release='', $os='', $osversion='', $identity='', $context='', $comment='', $address=null, $tcponly=false, $idlesecs=0, $udpPing=0.0, $tcpPing=0.0)
        {
...
if(!interface_exists('Murmur_ServerAuthenticator'))
{
    ...
    {
        public function authenticate($name, $pw, $certificates, $certhash, $certstrong, $newname);
    ...
    IcePHP_defineOperation($Murmur__t_ServerAuthenticator, 'authenticate', 2, 2, 0, array(array($IcePHP__t_string, false, 0), array($IcePHP__t_string, false, 0), array($Murmur__t_CertificateList, false, 0), array($IcePHP__t_string, false, 0), array($IcePHP__t_bool, false, 0)), array(array($IcePHP__t_string, false, 0)), array($IcePHP__t_int, false, 0), null);
