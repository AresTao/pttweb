...
if(!class_exists('Murmur_User'))
{
    class Murmur_User
    {
        public function __construct($session=0, $entid=0, $userid=0, $online=false, $channel=0, $account='', $name='')
        {
    ...
    $Murmur__t_User = IcePHP_defineStruct('::Murmur::User', 'Murmur_User', array(
        ...
        array('account', $IcePHP__t_string), 
        array('name', $IcePHP__t_string)));
}

if(!isset($Murmur__t_byteList))
{
    $Murmur__t_byteList = IcePHP_defineSequence('::Murmur::byteList', $IcePHP__t_byte);
}
...
if(!class_exists('Murmur_PhotoSummary'))
{
    class Murmur_PhotoSummary
    {
        public function __construct($recordid=0, $entid=0, $userid=0, $time=0, $title='', $path='')
        {
        ...
        public function __toString()
        {
            global $Murmur__t_PhotoSummary;
            return IcePHP_stringify($this, $Murmur__t_PhotoSummary);
        }
    ...
    $Murmur__t_PhotoSummary = IcePHP_defineStruct('::Murmur::PhotoSummary', 'Murmur_PhotoSummary', array(
        array('recordid', $IcePHP__t_int), 
        array('entid', $IcePHP__t_int), 
        array('userid', $IcePHP__t_int), 
        array('time', $IcePHP__t_long), 
        array('title', $IcePHP__t_string), 
        array('path', $IcePHP__t_string)));
}

if(!class_exists('Murmur_VideoSummary'))
{
    class Murmur_VideoSummary
    {
        public function __construct($recordid=0, $entid=0, $userid=0, $time=0, $title='', $path='')
        {
            $this->recordid = $recordid;
        ...
        public function __toString()
        {
            global $Murmur__t_VideoSummary;
            return IcePHP_stringify($this, $Murmur__t_VideoSummary);
        }
    ...
    $Murmur__t_VideoSummary = IcePHP_defineStruct('::Murmur::VideoSummary', 'Murmur_VideoSummary', array(
        array('recordid', $IcePHP__t_int), 
        array('entid', $IcePHP__t_int), 
        array('userid', $IcePHP__t_int), 
        array('time', $IcePHP__t_long), 
...
if(!class_exists('Murmur_Location'))
{
    class Murmur_Location
    {
        public function __construct($recordid=0, $entid=0, $userid=0, $time=0, $longitude=0.0, $latitude=0.0, $radius=0.0)
        {
            $this->recordid = $recordid;
            $this->entid = $entid;
            $this->userid = $userid;
        ...
        public function __toString()
        {
            global $Murmur__t_Location;
            return IcePHP_stringify($this, $Murmur__t_Location);
        }
    ...
    $Murmur__t_Location = IcePHP_defineStruct('::Murmur::Location', 'Murmur_Location', array(
        array('recordid', $IcePHP__t_int), 
        array('entid', $IcePHP__t_int), 
        array('userid', $IcePHP__t_int), 
        array('time', $IcePHP__t_long), 
        array('longitude', $IcePHP__t_double), 
        array('latitude', $IcePHP__t_double), 
        array('radius', $IcePHP__t_double)));
}
...
if(!class_exists('Murmur_Channel'))
{
    ...
    {
        public function __construct($entid=0, $id=0, $name='', $temporary=false, $members='', $fencestart=0, $fenceend=0, $fencepoints='')
        {
            $this->entid = $entid;
            $this->id = $id;
            $this->name = $name;
    ...
    $Murmur__t_Channel = IcePHP_defineStruct('::Murmur::Channel', 'Murmur_Channel', array(
        ...
        array('fencestart', $IcePHP__t_int), 
        array('fenceend', $IcePHP__t_int), 
        array('fencepoints', $IcePHP__t_string)));
}
...
if(!class_exists('Murmur_UserInfo'))
{
    class Murmur_UserInfo
    {
        ...
        const Email = 4;
        const Phone = 5;
        const CurrentChannelId = 6;
        const ExpireTime = 7;
        const FenceAlarm = 8;
    }

    $Murmur__t_UserInfo = IcePHP_defineEnum('::Murmur::UserInfo', array('Account', 0, 'Password', 1, 'Name', 2, 'Comment', 3, 'Email', 4, 'Phone', 5, 'CurrentChannelId', 6, 'ExpireTime', 7, 'FenceAlarm', 8));
}

if(!isset($Murmur__t_PhotoSummaryMap))
{
    $Murmur__t_PhotoSummaryMap = IcePHP_defineDictionary('::Murmur::PhotoSummaryMap', $IcePHP__t_int, $Murmur__t_PhotoSummary);
}

if(!isset($Murmur__t_VideoSummaryMap))
{
    $Murmur__t_VideoSummaryMap = IcePHP_defineDictionary('::Murmur::VideoSummaryMap', $IcePHP__t_int, $Murmur__t_VideoSummary);
}

if(!isset($Murmur__t_LocationMap))
{
    $Murmur__t_LocationMap = IcePHP_defineDictionary('::Murmur::LocationMap', $IcePHP__t_int, $Murmur__t_Location);
}
...
if(!interface_exists('Murmur_Server'))
{
    interface Murmur_Server
    {
        ...
        public function getPhotoSummary($entid, $userid, $starttime, $endtime);
        public function getPhoto($recordid);
        public function getVideoSummary($entid, $userid, $starttime, $endtime);
        ...
        public function setPushInfo($entid, $channelid, $info);
        ...
        public function setChannelName($entid, $channelid, $name);
        public function addChannelMembers($entid, $channelid, $members);
        public function deleteChannelMembers($entid, $channelid, $members);
        public function getMemberLevel($entid, $channelid, $userid);
        public function setMemberLevel($entid, $channelid, $userid, $level);
        public function setChannelFence($entid, $channelid, $start, $end, $points);
        ...
        public function getRegisteredUserIds($entid, $filter);
    ...
    IcePHP_defineOperation($Murmur__t_Server, 'getPhotoSummary', 2, 2, 0, array(array($IcePHP__t_int, false, 0), array($IcePHP__t_int, false, 0), array($IcePHP__t_int, false, 0), array($IcePHP__t_int, false, 0)), null, array($Murmur__t_PhotoSummaryMap, false, 0), array($Murmur__t_ServerBootedException, $Murmur__t_InvalidSecretException));
    IcePHP_defineOperation($Murmur__t_Server, 'getPhoto', 2, 2, 0, array(array($IcePHP__t_int, false, 0)), null, array($Murmur__t_byteList, false, 0), array($Murmur__t_ServerBootedException, $Murmur__t_InvalidSecretException));
    IcePHP_defineOperation($Murmur__t_Server, 'getVideoSummary', 2, 2, 0, array(array($IcePHP__t_int, false, 0), array($IcePHP__t_int, false, 0), array($IcePHP__t_int, false, 0), array($IcePHP__t_int, false, 0)), null, array($Murmur__t_VideoSummaryMap, false, 0), array($Murmur__t_ServerBootedException, $Murmur__t_InvalidSecretException));
    IcePHP_defineOperation($Murmur__t_Server, 'getVideo', 2, 2, 0, array(array($IcePHP__t_int, false, 0)), null, array($Murmur__t_byteList, false, 0), array($Murmur__t_ServerBootedException, $Murmur__t_InvalidSecretException));
    IcePHP_defineOperation($Murmur__t_Server, 'getLocation', 2, 2, 0, array(array($IcePHP__t_int, false, 0), array($IcePHP__t_int, false, 0), array($IcePHP__t_int, false, 0), array($IcePHP__t_int, false, 0)), null, array($Murmur__t_LocationMap, false, 0), array($Murmur__t_ServerBootedException, $Murmur__t_InvalidSecretException));
    IcePHP_defineOperation($Murmur__t_Server, 'getChannelLocations', 2, 2, 0, array(array($IcePHP__t_int, false, 0), array($IcePHP__t_int, false, 0)), null, array($IcePHP__t_string, false, 0), array($Murmur__t_ServerBootedException, $Murmur__t_InvalidSecretException));
    IcePHP_defineOperation($Murmur__t_Server, 'setPushInfo', 0, 0, 0, array(array($IcePHP__t_int, false, 0), array($IcePHP__t_int, false, 0), array($IcePHP__t_string, false, 0)), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidEntException, $Murmur__t_InvalidSecretException));
    ...
    IcePHP_defineOperation($Murmur__t_Server, 'setChannelName', 2, 2, 0, array(array($IcePHP__t_int, false, 0), array($IcePHP__t_int, false, 0), array($IcePHP__t_string, false, 0)), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidChannelException, $Murmur__t_InvalidSecretException));
    IcePHP_defineOperation($Murmur__t_Server, 'addChannelMembers', 2, 2, 0, array(array($IcePHP__t_int, false, 0), array($IcePHP__t_int, false, 0), array($IcePHP__t_string, false, 0)), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidChannelException, $Murmur__t_InvalidSecretException));
    IcePHP_defineOperation($Murmur__t_Server, 'deleteChannelMembers', 2, 2, 0, array(array($IcePHP__t_int, false, 0), array($IcePHP__t_int, false, 0), array($IcePHP__t_string, false, 0)), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidChannelException, $Murmur__t_InvalidSecretException));
    IcePHP_defineOperation($Murmur__t_Server, 'getMemberLevel', 2, 2, 0, array(array($IcePHP__t_int, false, 0), array($IcePHP__t_int, false, 0), array($IcePHP__t_int, false, 0)), null, array($IcePHP__t_int, false, 0), array($Murmur__t_ServerBootedException, $Murmur__t_InvalidChannelException, $Murmur__t_InvalidSecretException));
    IcePHP_defineOperation($Murmur__t_Server, 'setMemberLevel', 2, 2, 0, array(array($IcePHP__t_int, false, 0), array($IcePHP__t_int, false, 0), array($IcePHP__t_int, false, 0), array($IcePHP__t_int, false, 0)), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidChannelException, $Murmur__t_InvalidSecretException));
    IcePHP_defineOperation($Murmur__t_Server, 'setChannelFence', 2, 2, 0, array(array($IcePHP__t_int, false, 0), array($IcePHP__t_int, false, 0), array($IcePHP__t_int, false, 0), array($IcePHP__t_int, false, 0), array($IcePHP__t_string, false, 0)), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidChannelException, $Murmur__t_InvalidSecretException));
    ...
    IcePHP_defineOperation($Murmur__t_Server, 'getRegisteredUserIds', 2, 2, 0, array(array($IcePHP__t_int, false, 0), array($IcePHP__t_string, false, 0)), null, array($IcePHP__t_string, false, 0), array($Murmur__t_ServerBootedException, $Murmur__t_InvalidSecretException));
    IcePHP_defineOperation($Murmur__t_Server, 'getFriends', 2, 2, 0, array(array($IcePHP__t_int, false, 0), array($IcePHP__t_int, false, 0)), null, array($IcePHP__t_string, false, 0), array($Murmur__t_ServerBootedException, $Murmur__t_InvalidUserException, $Murmur__t_InvalidSecretException));
    IcePHP_defineOperation($Murmur__t_Server, 'addFriends', 2, 2, 0, array(array($IcePHP__t_int, false, 0), array($IcePHP__t_int, false, 0), array($IcePHP__t_string, false, 0)), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidUserException, $Murmur__t_InvalidSecretException));
    IcePHP_defineOperation($Murmur__t_Server, 'deleteFriends', 2, 2, 0, array(array($IcePHP__t_int, false, 0), array($IcePHP__t_int, false, 0), array($IcePHP__t_string, false, 0)), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidUserException, $Murmur__t_InvalidSecretException));
