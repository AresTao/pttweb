...
<!-- dcHead 结束 --> <div id="dcLeft"><div id="menu">
 ...
 <?php
   ...
   ?>
<div id="urHere">Admin<b>></b><strong>Photo List</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
        <h3> <div style="width:10px;"></div><a href="?page=user&sid=1" class="actionBtn">Back To List</a> Photo List</h3>
...
?>
      ...
      <td align="center">
             <a href="javascript:;" onclick="jq_photo_check('<?php echo $url;?>');">Detail</a>
      </td>
      </tr>
