	...
	var num;
      ...
      $.ajax
       ({
           ...
           data: { sid: "1" },
		   dataType: "json",
           url: "./?ajax=server_getEnterprises_en&page=enterprise2&najax=1&parentId=<?php echo SessionManager::getInstance()->getLoginId();?>",
         ...
         $(function () {
              ...
              InitTable(0);    //Load事件，初始化表格数据，页面索引为0（第一页）
                ...
                function InitTable(pageIndex) {                                  
                    $.ajax({   
                        type: "POST",  
                        url: './?ajax=server_getEnterprises_en&page=enterprise2&parentId=<?php echo SessionManager::getInstance()->getLoginId();?>',      //提交到一般处理程序请求数据   
...
<div id="urHere">Admin<b>></b><strong>Enterprise User List</strong> </div>
   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
        <h3><a href="" id="pldr" class="actionBtn add hint_trigger" >Batch In<span class="hintimg"></span></a><div style="width:10px;"></div>  <a href="./?page=enterprise2&sid=1&action=add" class="actionBtn add">Add New Enterprise</a> Enterprise User List</h3>
...
<div id="urHere">Admin<b></b><strong>Enterprise User</strong> </div> 
  <div id="manager" class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    <h3><a href="?page=enterprise2&sid=1" class="actionBtn">Back To List</a>Add New Enterprise</h3>
...
<div id="urHere">Admin<b>></b><strong>Enterprise User</strong> </div> 
  <div id="manager" class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    <h3><a href="?page=enterprise2&sid=1" class="actionBtn">Back To List</a>Edit Enterprise</h3>
...
<div id="urHere">Admin<b>></b><strong>Enterprise User</strong> </div>
  <div id="manager" class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    <h3><a href="?page=enterprise2&sid=1" class="actionBtn">Back To List</a>Dispatch</h3>
...
function jq_enterprise_update()
{
    ...
    $.post("./?ajax=server_enterprise_update&parentId="+<?php echo SessionManager::getInstance()->getLoginId();?>+"&id="+id,param,
            ...
            //$(".message").show().html(data);
            window.wxc.xcConfirm("Updae success.", window.wxc.xcConfirm.typeEnum.success);
